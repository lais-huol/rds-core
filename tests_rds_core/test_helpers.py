import unittest
import pytest
from rds_core.helpers import get_class, instantiate_class, get_variable_by_pathname
from rds_core.helpers.cnes import is_cpf_or_cns
from rds_core.helpers.http_client import HTTPException, get, get_json
